...
export const Footer = () => {
  return (
    <div className='w-full mt-24 bg-slate-900 text-gray-300 py-y px-2'>
        <div className='max-w-[1240px] mx-auto grid-cols-2 grid md:grid-cols-6 border-b-2 border-gray-600 py-8'>
            <div>
            ...
            <div className='col-span-2 pt-8 md:pt-2'>
                ...
                <form className='flex flex-col sm:flex-row'>
                    <input className='w-full p-2 mr-4 rounded-md mb-4' type="email" placeholder='Enter email id' />
